...
class PDF_Farmacia extends TCPDF {
    private $reportTitle = '';
    ...
    public function Header() {
        ...
        $this->Cell(0, 10, 'SISTEMA DE INVENTARIO - FARMACIA', 0, 1, 'C');
...
class ReporteController {
    ...
    private function generarPDFInventario($datos) {
        ...
        $pdf = new PDF_Farmacia('P', 'mm', 'A4', true, 'UTF-8', false);
        $pdf->setReportTitle('REPORTE DE INVENTARIO GENERAL');
        
        // Configurar documento
        $pdf->SetCreator('Sistema Farmacia');
    ...
    private function generarPDFMovimientos($datos, $fechaInicio, $fechaFin) {
        $pdf = new PDF_Farmacia('L', 'mm', 'A4', true, 'UTF-8', false); // Horizontal
